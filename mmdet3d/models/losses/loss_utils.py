...
def geo_scal_loss(pred, ssc_target, semantic=True):
    """
    args:
        pred: [bs, num_classes, volume_w, volume_h, volume_z]
        ssc_target: [bs, volume_w, volume_h, volume_z]
    """
    ...
    mask = ssc_target != 255 # [bs, volume_w, volume_h, volume_z]
    nonempty_target = ssc_target != 0 # [bs, volume_w, volume_h, volume_z]
...
def sem_scal_loss(pred, ssc_target):
    ...
    for i in range(0, n_classes):
        ...
        p = p[mask] # [N,], probability of i of voxels(!=255)
        target = ssc_target[mask] # [N,], gt of voxels(!=255)
